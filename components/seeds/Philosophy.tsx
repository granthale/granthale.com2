...
const Philosophy = () => {
  return (
    <>
      <p>
        Historically I haven't given philosophy much of a chance, but as of late
        2023, it's been one of my most frequented genres. Here are some of the
        pieces that have effected my thinking the most.
      </p>
